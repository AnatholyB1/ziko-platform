          ...
          /* @__PURE__ */ jsxRuntime.jsxs(
            components.Section,
            {
              ...
              children: [
                ...
                /* @__PURE__ */ jsxRuntime.jsxs(components.Text, { style: { fontSize: "14px", color: "#1C1A17", margin: "0 0 4px 0" }, children: [
                  "Bonjour ",
                  coachName,
                  ","
                ] }),
                /* @__PURE__ */ jsxRuntime.jsx(components.Text, { style: { fontSize: "14px", color: "#1C1A17", margin: "0 0 24px 0" }, children: "Voici les points cles de vos clients cette semaine." }),
                alertClients.length > 0 && /* @__PURE__ */ jsxRuntime.jsxs(jsxRuntime.Fragment, { children: [
                  /* @__PURE__ */ jsxRuntime.jsxs(
                    components.Text,
                    {
                      style: {
                  ...
                  alertClients.map((client) => /* @__PURE__ */ jsxRuntime.jsxs(
                    components.Section,
                    {
                      style: {
                        backgroundColor: "#F7F6F3",
                ...
                okClientNames.length > 0 && /* @__PURE__ */ jsxRuntime.jsxs(jsxRuntime.Fragment, { children: [
                  /* @__PURE__ */ jsxRuntime.jsxs(
                    components.Text,
                    {
                      style: {
                  ...
                  /* @__PURE__ */ jsxRuntime.jsx(
                    components.Section,
                    {
                      ...
                      children: /* @__PURE__ */ jsxRuntime.jsxs(components.Text, { style: { fontSize: "13px", color: "#6B6963", margin: 0 }, children: [
                        okClientNames.join(", "),
                        " \u2014 RAS"
                      ] })
                    }
