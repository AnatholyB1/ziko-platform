...
1. **Should the plain `instructions`/`instructions_fr` TEXT columns be used as a fallback display when `instruction_steps` is null but the legacy text columns are populated?**
