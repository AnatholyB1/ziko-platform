...
- [x] **Phase 4: Mobile Consumption & Attribution** - Real media, structured instructions, and mandatory attribution render in the app (completed 2026-08-18)
...
- [x] 02-02-PLAN.md — Shared lib: zod contracts (dataset/production/report), name normalization + similarity, read-only paginated Supabase client
...
Plans:
- [x] 04-01-PLAN.md — Shared `<AttributedMedia>` in `packages/ui` (180×180 clamp + Gym visual badge + barbell fallback) and 3 FR/EN i18n keys
- [x] 04-02-PLAN.md — `ExercisePicker`: 40×40 row thumbnails from `image`, versioned `['exercises','v2','picker']` key
- [x] 04-03-PLAN.md — Detail screen: square attributed GIF hero replacing the fake video chrome, `instruction_steps` bilingual numbered steps, versioned `['exercises','v2',id]` key
- [x] 04-04-PLAN.md — Static sweep + blocking manual device verification (manual-only validation, no RN test infra)
...
| 4. Mobile Consumption & Attribution | 4/4 | Complete    | 2026-08-18 |
