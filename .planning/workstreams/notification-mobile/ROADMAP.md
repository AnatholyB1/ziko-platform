...
- [x] 06-03-PLAN.md — LOCAL-02/LOCAL-03: Workout reminder UI in workout/[id].tsx (weekday chips, time picker, WEEKLY scheduling, 600ms UPSERT) · Wave 2
- [~] 06-04-PLAN.md — APP-01: OTA update card in notifications.tsx (useUpdates, ListHeaderComponent, __DEV__ debug flag) · Wave 1 [Task 1 done; checkpoint:human-verify Task 2 pending]
**UI hint:** yes
