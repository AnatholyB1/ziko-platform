...
**Plans:** 4 plans
Plans:
- [ ] 04-01-PLAN.md -- Repair RTL test infra (@testing-library/dom missing) + 9 Phase 4 i18n keys (fr/en)
- [ ] 04-02-PLAN.md -- Wave 0 test file: 6 RED tests covering REVIEW-01/02/03, COMPLETE-01/02, D-09 retry isolation
