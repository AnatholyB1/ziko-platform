# Requirements Archive: v1.14 Formulaires Conditionnels
...
- [x] **RESPONSES-01**: Coach sees a "Formulaires" tab in the client detail sheet listing all submitted forms with date
- [x] **RESPONSES-02**: Coach can expand a submission to read all questions and answers
- [x] **RESPONSES-03**: Pending forms for a client are visible in the "Formulaires" tab with a "En attente" badge

### CLAUDE — AI Context Injection

- [x] **CLAUDE-01**: When the AI coach orchestrator is called, the last 5 submitted form responses for the athlete are injected into the system prompt context
- [x] **CLAUDE-02**: The injected context includes: form title, date, and question+answer pairs formatted as readable text
...
| RESPONSES-01 | Phase 05 | Complete |
| RESPONSES-02 | Phase 05 | Complete |
| RESPONSES-03 | Phase 05 | Complete |
| CLAUDE-01 | Phase 05 | Complete |
| CLAUDE-02 | Phase 05 | Complete |
