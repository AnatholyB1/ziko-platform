...
export function CoachsFounderSectionClient({ heading, quote, story, name, title }: Props) {
        ...
        >
          <div className="flex flex-col md:flex-row gap-8 items-start">
            ...
            <div className="flex-1">
              ...
              <p className="text-xl font-bold text-text leading-snug mb-4">{quote}</p>
              {/* TODO: replace with real founder story before go-live */}
              <p className="text-base text-muted leading-relaxed">{story}</p>
            </div>
