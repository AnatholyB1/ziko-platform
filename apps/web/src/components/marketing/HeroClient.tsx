...
export function HeroClient({ badge, headline1, headline2, headline3, subline, ctaAppStore, ctaPlayStore, ctaCoach }: Props) {
  ...
  const headlines = [headline1, headline2, headline3]
